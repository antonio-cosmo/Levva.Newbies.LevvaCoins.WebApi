...
//            _repositoryMock.Setup(repo => repo.GetByDescriptionAsync(It.IsAny<string>(), CancellationToken.None))
//                .ReturnsAsync(null as Category);

//            _repositoryMock.Setup(repo => repo.InsertAsync(It.IsAny<Category>(), CancellationToken.None));

//            // Act
//           await _commandHandler.Handle(command, CancellationToken.None);

//            // Assert
//            _repositoryMock.Verify(x => x.InsertAsync(It.IsAny<Category>(), CancellationToken.None), Times.Exactly(1));
//            _repositoryMock.Verify(x => x.GetByDescriptionAsync(It.IsAny<string>(), CancellationToken.None), Times.Exactly(1));
//        }
...
//            _repositoryMock.Setup(x => x.GetByDescriptionAsync(It.IsAny<string>(), CancellationToken.None)).ReturnsAsync(existsCategory);
...
//        public  void InvalidCategory_ThrowsDomainValidationException()
//        {
//            //Arrange
...
//            _repositoryMock.Setup(x => x.GetByDescriptionAsync(It.IsAny<string>(), CancellationToken.None)).ReturnsAsync(null as Category);
